...
public class ProductoJpaController implements Serializable {
    ...
    public void create(Producto producto) throws RollbackFailureException, Exception {
        ...
        try {
            ...
            if (idMarca != null) {
                idMarca.getProductoCollection().add(producto);
    ...
    public void edit(Producto producto) throws NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            if (idMarcaOld != null && !idMarcaOld.equals(idMarcaNew)) {
                idMarcaOld.getProductoCollection().remove(producto);
                idMarcaOld = em.merge(idMarcaOld);
            }
            if (idMarcaNew != null && !idMarcaNew.equals(idMarcaOld)) {
                idMarcaNew.getProductoCollection().add(producto);
    ...
    public void destroy(Integer id) throws NonexistentEntityException, RollbackFailureException, Exception {
        ...
        try {
            ...
            Marca idMarca = producto.getIdMarca();
            if (idMarca != null) {
                idMarca.getProductoCollection().remove(producto);
                idMarca = em.merge(idMarca);
            }
            Proveedor idProveedor = producto.getIdProveedor();
            if (idProveedor != null) {
